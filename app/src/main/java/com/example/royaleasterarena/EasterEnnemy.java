...
public class EasterEnnemy {
    public static void extractWarriorEnnemy(Context context, final EasterEnnemy.WarriorEnnemyListener listener) {
            ...
            JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(
                    ...
                    new Response.Listener<JSONObject>() {
                        ...
                        public void onResponse(JSONObject response) {
                            ...
                            listener.onWarriorsEnnemy(warriors);
    ...
    public interface WarriorEnnemyListener {
        void onWarriorsEnnemy (List<Warrior> warriors);
    }
}
